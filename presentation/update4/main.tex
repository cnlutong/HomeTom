        ...
        \column{0.65\textwidth} 
            ...
            \begin{tikzpicture}[x=2.5cm, y=-0.45cm] 
                ...
                \onslide<2->{
                    ...
                    \draw[msg] ($(O)+(0,10.9)$) -- node[lbl] {execute(execution, definition)} ($(W)+(0,10.9)$);
                    \draw[msg] ($(O)+(0,12.1)$) -- node[lbl] {save(execution)} ($(ER)+(0,12.1)$);
        ...
        \column{0.65\textwidth} 
            ...
            \begin{tikzpicture}[node distance=0.6cm and 0.2cm] 
                ...
                \onslide<3->{
                    ...
                    \node[draw, cylinder, shape border rotate=90, aspect=0.25, fill=gray!20, minimum height=0.8cm, minimum width=6.5cm, below=0.8cm of smod, align=center, font=\small] (db) {DB (SQLite/PG)};
